...
const OldAppointments = () => {
  ...
  async function fetchServerData(search = "", page = 1, setloading = null) {
    ...
    let newQueryParams = { ...QueryParams("getAllAppointmentsByDoctor", "?") }
    ...
    const { data } = await getRequest(Routesfiles(newQueryParams)?.getAllAppointmentsByDoctor, setloading)
  ...
  return (
    <>
      <div>
        {
          <DataTable
            title="Old Total Appointment Records ( Patient )"
