...
const DailyAppointments = () => {
  ...
  async function fetchServerData(setloading) {
    ...
    let newQueryParams = { ...QueryParams("getAllTodayAppointmentsByDoctor", "?") }
    newQueryParams.setQuery += `doctor_id=${id}`

    const { data } = await getRequest(Routesfiles(newQueryParams)?.getAllTodayAppointmentsByDoctor, setloading)
